...
<head>
  ...
  <link rel="stylesheet" href="css/style_forgotpassword_mobile.css">
  ...
  <div class="container Roboto">
    <form action="index.php" method="post">
      <div class="box1">
        ...
        <br>
        <input type="tel" name="username" class="input1" maxlength="10" required>
      ...
      <div class="box2">
        ...
        <p><a href="forgotpassword_email.php">try using email?</a></p>
      </div>
    </form>
  </div>
  <script>
